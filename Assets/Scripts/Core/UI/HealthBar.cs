...
namespace UnityRoyale
{
    public class HealthBar : MonoBehaviour
    {
        ...
        public void Initialise(ThinkingPlaceable p)
        {
            ...
            wholeWidget.transform.localPosition = new Vector3(0f, (p.pType == Placeable.PlaceableType.Unit) ? 3f : 6f, (p.pType == Placeable.PlaceableType.Unit) ? 0f : -2f); //set the vertical position based on the type of Placeable
